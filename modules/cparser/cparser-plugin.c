...
static Plugin cparser_plugins[] =
{
  {
    .type = LL_CONTEXT_PARSER,
    .name = "cparser",
    .parser = &cparser_parser,
  },
};

gboolean
cparser_module_init(GlobalConfig *cfg, CfgArgs *args)
{
  plugin_register(cfg, cparser_plugins, G_N_ELEMENTS(cparser_plugins));
  return TRUE;
}
